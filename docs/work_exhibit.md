...
Competitions provide deadlines, publishing provides feedback, and events provide an audience.
Each is a route out of the workshop for finished work.

Dates checked 2026-09. Each event's own site should be consulted before planning around it.

---

## Competitions worth entering

*A fixed date is the most reliable way to bring a project to completion.*
...
*The step that turns a working prototype into something others can reproduce.*

- **[Hackaday.io](https://hackaday.io/)** — Project hosting at the scale a student team completes, with an audience that reads build logs. — `free`
- **[Weekly Robotics](https://www.weeklyrobotics.com/)** — A newsletter that regularly features community projects, and a realistic first venue for visibility. — `free`
